...
.. raw:: html
   ...
   <div style="background-color: #e7f3e7; padding: 15px; border-radius: 5px; margin: 20px 0;">
       <h3 style="margin-top: 0;"> API Status: (Currently in the process of moving! Sorry for the inconvenience) </h3>
       <p><strong>Base URL:</strong> <code>http://nyassembly.duckdns.org:8888</code></p>
       <p><strong>Status:</strong> <span style="color: green; font-weight: bold;">in-service</span></p>
